...
export const BrollLayer:React.FC<{asset:BrollAsset}>=({asset})=> <div style={{position:"absolute",inset:0,overflow:"hidden",background:"#dce7e8"}}>
  <Html5Video src={staticFile(asset.path)} muted loop style={{width:"100%",height:"100%",objectFit:"cover",filter:"saturate(.65) contrast(.9) brightness(.78)",transform:"scale(1.04)"}}/>
